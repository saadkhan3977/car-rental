 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            @foreach($cars as $car)
                <tr>
                    ...
                    <td>
                        @if($car->image)
                            <img src="{{$car->image}}" class="img-fluid zoom" style="max-width:80px" alt="{{$car->image}}">
                        @else
                    ...
                    <td>
                      @if(auth()->user()->role =='admin')
                        <a href="{{route('car.edit',$car->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        @else
                        <a href="{{route('vcar.edit',$car->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        @endif
        ...
        @else
          <h6 class="text-center">No Car found!!! Please create Car</h6>
        @endif
      </div>
    </div>
</div>
